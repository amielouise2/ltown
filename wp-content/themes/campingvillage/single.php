        ...
        while(have_posts()) : the_post(); ?>
            ...
            <div class="nicdark_section">
                ...
                <?php $args = array(
                    ...
                    'nextpagelink'     => esc_html__('Next page', 'campingvillage'),
                    'previouspagelink' => esc_html__('Previous page', 'campingvillage'),
                    'pagelink'         => '%',
                    'echo'             => 1
                ); ?>
                ...
                <?php if(has_tag()) { ?>  
                    ...
                    <div id="nicdark_tags_list" class="nicdark_section">
                        <?php esc_html_e('Tags : ','campingvillage'); ?>
                        <br/>
                        <?php the_tags('','',''); ?>
                    </div>
                    <!--END tag-->
                ...
                <?php 
                    esc_html_e('Categories : ','campingvillage');
                    the_category();
                ?>
                </div>
                <!--END categories-->
