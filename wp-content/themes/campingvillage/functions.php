...
function nicdark_register_required_plugins() {
    ...
    $nicdark_plugins = array(
        ...
        //cf7
        array(
            'name'      => esc_html__( 'Contact Form 7', 'campingvillage' ),
            'slug'      => 'contact-form-7',
            'required'  => true,
        ),
        ...
        //wp import
        array(
            'name'      => esc_html__( 'Wordpress Importer', 'campingvillage' ),
        ...
        //nd restaurant
        array(
            'name'      => esc_html__( 'ND Booking', 'campingvillage' ),
            'slug'      => 'nd-booking',
            'required'  => true,
        ),
        ...
        //nd shortcodes
        array(
            'name'      => esc_html__( 'ND Shortcodes', 'campingvillage' ),
            'slug'      => 'nd-shortcodes',
            'required'  => true,
        ),
        ...
        //revslider
        array(
            'name'               => esc_html__( 'Revolution Slider', 'campingvillage' ),
        ...
        //Visual Composer
        array(
            'name'               => esc_html__( 'Visual Composer', 'campingvillage' ),
    ...
    $nicdark_config = array(
        'id'           => 'campingvillage',                 // Unique ID for hashing notices for multiple instances of TGMPA.
...
//translation
load_theme_textdomain( 'campingvillage', get_template_directory().'/languages' );


//register my menus
function nicdark_register_my_menus() {
  register_nav_menu( 'main-menu', esc_html__( 'Main Menu', 'campingvillage' ) );  
}
...
function nicdark_add_sidebars() {
    ...
    register_sidebar(array(
        'name' =>  esc_html__('Sidebar','campingvillage'),
        'id' => 'nicdark_sidebar',
...
function nicdark_enqueue_scripts()
{
    ...
    //css
    wp_enqueue_style( 'campingvillage-style', get_stylesheet_uri() );
...
function nicdark_customizer_logo( $wp_customize ) {
    ...
    $wp_customize->add_control( 
        new WP_Customize_Media_Control( 
            ...
            array(
              'label' => esc_html__( 'Logo', 'campingvillage' ),
...
function nicdark_custom_search_form( $nicdark_search_form ) { 
    ...
    <form role="search" method="get" id="searchform" class="searchform" action="'.home_url('/').'">
        <div>
            <label class="screen-reader-text" for="s">'.esc_attr__('Search for', 'campingvillage').' :</label>
            <input type="text" value="'.get_search_query().'" placeholder="'.esc_attr__('Keyword', 'campingvillage').' ..." name="s" id="s">
            <input type="submit" id="searchsubmit" value="'.esc_attr__('Search', 'campingvillage').'">
        </div>
    </form>';
