	...
	function nd_booking_send_message($nd_booking_id_post,$nd_booking_title_post,$nd_booking_date,$nd_booking_date_from,$nd_booking_date_to,$nd_booking_guests,$nd_booking_final_trip_price,$nd_booking_extra_services,$nd_booking_id_user,$nd_booking_user_first_name,$nd_booking_user_last_name,$nd_booking_paypal_email,$nd_booking_user_phone,$nd_booking_user_address,$nd_booking_user_city,$nd_booking_user_country,$nd_booking_user_message,$nd_booking_user_arrival,$nd_booking_user_coupon,$nd_booking_paypal_payment_status,$nd_booking_paypal_currency,$nd_booking_paypal_tx,$nd_booking_stripe_error,$nd_booking_action_type){
		...
		if ( $nd_booking_extra_services == '' ) {
	        ...
	        for ($nd_booking_services_array_i = 0; $nd_booking_services_array_i < count($nd_booking_services_array)-1; $nd_booking_services_array_i++) {
				...
				$nd_booking_extra_services_result .= '<p>'.$nd_booking_service_title.' : 
					'.$nd_booking_paypal_currency.'
					'.$nd_booking_service_price.'</p>';    
		...
		if ( $nd_booking_extra_services_1 == '' ) {
	        ...
	        for ($nd_booking_services_array_i = 0; $nd_booking_services_array_i < count($nd_booking_services_array)-1; $nd_booking_services_array_i++) {
				...
				<p style="margin:0px; padding:0px; float:left; width:100%; color:#878787;">'.$nd_booking_service_title.' : '.$nd_booking_paypal_currency.'
					'.$nd_booking_service_price.' </p>
	            <div style="float:left; width:100%; height:7px;"></div>
	            ';    
		...
		<body>
		  <p>'.__('Hi there, you received a new reservation on your site, here are the details','nd-booking').' :</p>
		  
		  <p><strong>'.__('MAIN INFORMATION','nd-booking').' :</strong></p>
		  ...
		  <p>'.__('Price','nd-booking').' :
		  '.$nd_booking_paypal_currency.'
		  '.$nd_booking_final_trip_price.' </p><br/>

		  <p><strong>'.__('EXTRA SERVICES ( calculated in the total price )','nd-booking').' :</strong></p>
		  '.$nd_booking_extra_services_result.'<br/>
		  
		  <p><strong>'.__('USER INFORMATION','nd-booking').' :</strong></p>
		  ...
		  <p><strong>'.__('PAYMENT INFORMATION','nd-booking').' :</strong></p>
		  <p>'.__('Payment Type','nd-booking').' : '.$nd_booking_action_type.'</p>
		  <p>'.__('Payment Status','nd-booking').' : '.$nd_booking_paypal_payment_status.'</p>
		  <p>'.__('Payment ID','nd-booking').' : '.$nd_booking_paypal_tx.'</p><br/>

		  <p><strong>'.__('CHECKIN INFORMATION','nd-booking').' :</strong></p>
		  <p>'.__('Lockbox Pin','nd-booking').' : '.$nd_booking_lockbox_pin.'</p>
		...
		<body>
			...
			<div style="width:500px; margin:left;">
		...
		<div style="text-align:center; float:left; width:100%; ">
			<img style="float:left; width:100%; height:auto;" src="'.nd_booking_get_post_img_src($nd_booking_id_post).'">
				...
				<p></p>
				<p style="margin:0px; padding:0px; float:left; width:100%; color:#878787;">'.__('Hi '.$nd_booking_user_first_name.', please find below your reservation details','nd-booking').'</p>
				...
				<div style="float:left; width:100%; ">
					...
					<h2 style="float:left; width:100%; text-align:center; color:#727475; font-weight:normal; margin:0px; padding:0px;">'.__('Main Information','nd-booking').' :</h2>
				...
				<div style="float:left; width:100%; ">
					...
					<div style="float:left; width:100%; height:40px;"></div>
					<h2 style="float:left; width:100%; text-align:center; color:#727475; font-weight:normal; margin:0px; padding:0px;">'.__('User Information','nd-booking').' :</h2>
					<div style="float:left; width:100%; height:20px;"></div>
					<div style="float:left; width:50%; background-color:#f9f9f9; padding:20px; box-sizing:border-box;">
				...
				<div style="float:left; width:100%; ">
					...
					<div style="float:left; width:100%; height:40px;"></div>
					<h2 style="float:left; width:100%; text-align:center; color:#727475; font-weight:normal; margin:0px; padding:0px;">'.__('Payment Information','nd-booking').' :</h2>
					<div style="float:left; width:100%; height:20px;"></div>
					<div style="float:left; width:100%; background-color:#f9f9f9; padding:20px; box-sizing:border-box;">
				...
				<div style="float:left; width:100%; ">
					...
					<div style="float:left; width:100%; height:40px;"></div>
					<h2 style="float:left; width:100%; text-align:center; color:#727475; font-weight:normal; margin:0px; padding:0px;">'.__('Checkin Information','nd-booking').' :</h2>
					<div style="float:left; width:100%; height:20px;"></div>
					<div style="float:left; width:100%; background-color:#f9f9f9; padding:20px; box-sizing:border-box;">
						<p style="margin:0px; padding:0px; float:left; width:100%; color:#878787;">'.__('Lockbox Pin','nd-booking').' : '.$nd_booking_lockbox_pin.'</p>
		...
		//$headers = array('Content-Type: text/html; charset=UTF-8','From: Lawrencetown Lodge <'.$nd_booking_email.'>');
		$headers = array('Content-Type: text/html; charset=UTF-8','From: Lawrencetown Lodge <info@lawrencetownlodge.com>');
		...
		//wp_mail( 'amie@tribicsoftware.com', 'no subject test', 'no template', $headers );
		//wp_mail( 'amie.louise@me.com', 'hard coded wp_mail test', 'this is just a test of admin email', $headers );
		...
		<body>
		  <p>'.__('Hi '.$nd_booking_user_first_name.', please find below your reservation details','nd-booking').' :</p>
		  ...
		  <p><strong>'.__('YOUR INFORMATION','nd-booking').' :</strong></p>
		  <p>'.__('Name','nd-booking').' : '.$nd_booking_user_first_name.'</p>
		  <p>'.__('Surname','nd-booking').' : '.$nd_booking_user_last_name.'</p>
		  <p>'.__('Phone','nd-booking').' : '.$nd_booking_user_phone.'</p>
		  <p>'.__('Address','nd-booking').' : '.$nd_booking_user_address.'</p>
		...
		// Mail it
		wp_mail( $to, $subject, $nd_booking_template, $headers );
		//wp_mail( $to, 'no subject test', 'no template test', $headers );
		//wp_mail( 'amie.louise@me.com', 'hard coded wp_mail test', 'this is just a test of customer email' );
