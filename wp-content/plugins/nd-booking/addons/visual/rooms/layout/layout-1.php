...
<div id="nd_booking_archive_cpt_1_single_'.$nd_booking_id.'" class=" nd_booking_rooms_component_l1 nd_booking_masonry_item '.$nd_booking_width.' nd_booking_width_100_percentage_responsive">
    ...
    <div class="nd_booking_section nd_booking_padding_15 nd_booking_box_sizing_border_box">
        ...
        <div class="nd_booking_section nd_booking_border_1_solid_grey nd_booking_bg_white">
            ...
            <div class="nd_booking_section nd_booking_padding_30 nd_booking_box_sizing_border_box">
                ...
                <div class="nd_booking_section nd_booking_height_20"></div>
                <a style="border:2px solid '.$nd_booking_meta_box_color.'; color:'.$nd_booking_meta_box_color.';" href="'.$nd_booking_permalink.'" class="nd_booking_padding_15_30_important nd_options_second_font_important nd_booking_border_radius_0_important nd_booking_background_color_transparent_important nd_booking_cursor_pointer nd_booking_display_inline_block nd_booking_font_size_11 nd_booking_font_weight_bold nd_booking_letter_spacing_2">'.__('BOOK NOW FROM','nd-booking').' '.nd_booking_get_currency().''.$nd_booking_meta_box_price.' </a>
                ';
