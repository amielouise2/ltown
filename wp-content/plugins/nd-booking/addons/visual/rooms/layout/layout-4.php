...
$str .= '<div class="nd_booking_section nd_booking_rooms_component_l4 nd_booking_masonry_content '.$nd_booking_class.' ">';
...
<div id="nd_booking_archive_cpt_1_single_'.$nd_booking_id.'" class=" nd_booking_rooms_component_l4 nd_booking_masonry_item '.$nd_booking_width.' nd_booking_width_100_percentage_responsive">
