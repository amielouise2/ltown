...
$str .= '<div class=" nd_booking_rooms_component_l5 nd_booking_section nd_booking_masonry_content '.$nd_booking_class.' ">';
                ...
                <div class="nd_booking_position_absolute nd_booking_bottom_20 nd_booking_left_0 nd_booking_width_100_percentage">
                    ...
                    <div class="nd_booking_section nd_booking_text_align_center nd_booking_display_none_iphone_port">
                        <div class="nd_booking_display_table nd_booking_margin_auto">
                            <img alt="" class="nd_booking_margin_right_10 nd_booking_display_table_cell nd_booking_vertical_align_middle" width="23" src="'.esc_url(plugins_url('icon-user-white.png', __FILE__ )).'">
...
<div id="nd_booking_archive_cpt_1_single_'.$nd_booking_id.'" class=" nd_booking_rooms_component_l5  nd_booking_masonry_item '.$nd_booking_width.' nd_booking_width_100_percentage_responsive">
