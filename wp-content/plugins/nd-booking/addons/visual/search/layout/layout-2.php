...
$str .= '
    ...
    <div class=" nd_booking_search_component_l2 nd_booking_border_1_solid_grey nd_booking_section '.$nd_booking_class.' ">


        <!--start header-->
        <div style="background-color:'.$nd_booking_submit_bg.';" class="nd_booking_section nd_booking_text_align_center nd_booking_padding_30 nd_booking_box_sizing_border_box">
          <h2 class="nd_options_color_white">'.__('Search Rooms','nd-booking').'</h2>
          <div class="nd_booking_section nd_booking_height_10"></div>
          <p class="nd_options_color_white nd_booking_font_size_12 nd_booking_letter_spacing_2">'.__('START BOOKING','nd-booking').'</p>
        </div>
        <!--end header-->


        <!--START FORM-->
        <form style="padding-top:35px;" class="nd_booking_padding_30 nd_booking_box_sizing_border_box nd_booking_section nd_booking_bg_white" action="'.$nd_booking_action.'" method="get">
            ...
            <div class="nd_booking_width_100_percentage nd_booking_width_100_percentage_all_iphone nd_booking_float_left nd_booking_box_sizing_border_box ">
                ...
                <div class="nd_booking_width_50_percentage nd_booking_width_100_percentage_all_iphone  nd_booking_float_left nd_booking_box_sizing_border_box">
                    ...
                    <div id="nd_booking_open_calendar_from" class="nd_booking_section   nd_booking_box_sizing_border_box nd_booking_text_align_center nd_booking_cursor_pointer">
                      <div class="nd_booking_section  nd_booking_box_sizing_border_box nd_booking_text_align_center">
                        <h5 class="nd_options_color_grey  nd_options_second_font nd_booking_letter_spacing_2 nd_booking_font_size_12">'.__('CHECK-IN','nd-booking').'</h5>
                        ...
                        <div class="nd_booking_display_inline_flex ">
                          <div class="nd_booking_float_left nd_booking_text_align_right">
                            <h1 id="nd_booking_date_number_from_front" class="nd_booking_font_size_50 nd_options_color_greydark ">'.$nd_booking_date_number_from_front.'</h1>
                          </div>
                          <div class="nd_booking_float_right nd_booking_text_align_center nd_booking_margin_left_10">
                              <h6 id="nd_booking_date_month_from_front" class="nd_options_color_grey  nd_booking_margin_top_7 nd_booking_font_size_12">'.$nd_booking_date_month_from_front.'</h6>
                ...
                <div class="nd_booking_width_50_percentage nd_booking_width_100_percentage_all_iphone  nd_booking_float_left  nd_booking_box_sizing_border_box">
                    ...
                    <div id="nd_booking_open_calendar_to" class="nd_booking_section  nd_booking_box_sizing_border_box nd_booking_text_align_center nd_booking_cursor_pointer">
                      <div class="nd_booking_section  nd_booking_box_sizing_border_box nd_booking_text_align_center">
                        <h5 class="nd_options_color_grey nd_options_second_font nd_booking_letter_spacing_2 nd_booking_font_size_12 ">'.__('CHECK-OUT','nd-booking').'</h5>
                        <div class="nd_booking_section nd_booking_height_15"></div> 
                        <div class="nd_booking_section nd_booking_height_1 nd_options_border_bottom_1_solid_grey"></div> 
                        <div class="nd_booking_section nd_booking_height_30"></div> 
                        <div class="nd_booking_display_inline_flex ">
                          <div class="nd_booking_float_left nd_booking_text_align_right">
                            <h1 id="nd_booking_date_number_to_front" class="nd_booking_font_size_50 nd_options_color_greydark ">'.$nd_booking_date_number_to_front.'</h1>
                          </div>
                          <div class="nd_booking_float_right nd_booking_text_align_center nd_booking_margin_left_10">
                              <h6 id="nd_booking_date_month_to_front" class="nd_options_color_grey  nd_booking_margin_top_7 nd_booking_font_size_12">'.$nd_booking_date_month_to_front.'</h6>
                              <div class="nd_booking_section nd_booking_height_5"></div>
                              <img alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
                          </div>
                        </div>
                    ...
                    <div class="nd_booking_section  nd_booking_box_sizing_border_box nd_booking_text_align_center">
                      <div class="nd_booking_section  nd_booking_box_sizing_border_box nd_booking_text_align_center">
                        <div class="nd_booking_section nd_booking_position_relative">
                          ...
                          <img class="nd_booking_position_absolute nd_booking_left_0 nd_booking_top_0 nd_booking_guests_decrease nd_booking_cursor_pointer" alt="" width="20" src="'.esc_url(plugins_url('icon-decrease-grey.svg', __FILE__ )).'">
                          <h3 class=" nd_booking_color_greydark"><span class="nd_booking_guests_number">1</span> <span class="nd_booking_guests_number_word">'.__('GUEST','nd-booking').'</span></h3>
                          <img class="nd_booking_position_absolute nd_booking_right_0 nd_booking_top_0 nd_booking_guests_increase nd_booking_cursor_pointer" alt="" width="20" src="'.esc_url(plugins_url('icon-increase-grey.svg', __FILE__ )).'">
                  ...
                  jQuery(document).ready(function() {
                    ...
                    jQuery( function ( $ ) {
                      ...
                      $(".nd_booking_guests_increase").click(function() {
                        ...
                        if ( value > 1 ) {
                          $(".nd_booking_guests_number_word").text("'.__('GUESTS','nd-booking').'");  
                        }
                      ...
                      $(".nd_booking_guests_decrease").click(function() {
                        ...
                        if ( value == 1 ) {
                          $(".nd_booking_guests_number_word").text("'.__('GUEST','nd-booking').'");  
                        }
