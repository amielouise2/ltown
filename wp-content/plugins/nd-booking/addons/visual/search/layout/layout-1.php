...
$str .= '
    ...
    <div class=" nd_booking_search_component_l1 nd_booking_section '.$nd_booking_class.' ">
                        ...
                        <div class="nd_booking_display_inline_flex ">
                          ...
                          <div class="nd_booking_float_right nd_booking_text_align_center nd_booking_margin_left_10">
                              ...
                              <div class="nd_booking_section">
                                  <img class="nd_booking_float_right nd_booking_guests_increase nd_booking_cursor_pointer" style="transform: rotate(180deg);" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
                              </div>
                              <div class="nd_booking_section nd_booking_height_10"></div>
                              <div class="nd_booking_section">
                                  <img class="nd_booking_float_right nd_booking_guests_decrease nd_booking_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
                              </div>
                          </div>
                        </div>
                      </div> 
