...
function nd_booking_shortcode_order() {
    ...
    if ( is_user_logged_in() == 1 ){
          ...
          if( isset( $_POST['nd_booking_order_user_id'] ) ) {  $nd_booking_order_user_id = sanitize_text_field($_POST['nd_booking_order_user_id']); }else{ $nd_booking_order_user_id = '';} 
        ...
        if ( $nd_booking_current_user_id == $nd_booking_order_user_id ) {
            ...
            $nd_booking_order_room_id = sanitize_text_field($_POST['nd_booking_order_room_id']);
