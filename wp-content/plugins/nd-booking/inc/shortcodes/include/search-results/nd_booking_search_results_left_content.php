    ...
    <form id="nd_booking_search_cpt_1_form_sidebar">
        ...
        <div id="nd_booking_search_cpt_1_form_normal_services" class=" '.$nd_booking_search_class_2.' nd_booking_width_100_percentage nd_booking_float_left nd_booking_padding_0_15 nd_booking_box_sizing_border_box">
            ...
            <div class="nd_booking_section nd_booking_position_relative nd_booking_padding_30 nd_booking_padding_30_15_all_iphone nd_booking_box_sizing_border_box">
                ...
                <img class="nd_booking_toogle_services_open_content nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
                <img style="transform: rotate(180deg);" class="nd_booking_toogle_services_close_content nd_booking_display_none nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
            </div>
            ';
        ...
        <div id="nd_booking_search_cpt_1_form_extra_services" class=" '.$nd_booking_search_class_3.' nd_booking_width_100_percentage nd_booking_float_left nd_booking_padding_0_15 nd_booking_box_sizing_border_box">
            ...
            <div class="nd_booking_section nd_booking_position_relative nd_booking_padding_30 nd_booking_padding_30_15_all_iphone nd_booking_box_sizing_border_box">
                ...
                <img class="nd_booking_toogle_additional_services_open_content nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
                <img style="transform: rotate(180deg);" class="nd_booking_toogle_additional_services_close_content nd_booking_display_none nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
            </div>
            ';
        ...
        <div id="nd_booking_search_cpt_1_form_branch_stars" class="nd_booking_width_100_percentage nd_booking_display_none nd_booking_float_left nd_booking_padding_0_15 nd_booking_box_sizing_border_box">
            ...
            <div class="nd_booking_section nd_booking_position_relative nd_booking_padding_30 nd_booking_box_sizing_border_box">
                <h3>Branch Stars :</h3>
                <img class="nd_booking_toogle_branch_stars_open_content nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
                <img style="transform: rotate(180deg);" class="nd_booking_toogle_branch_stars_close_content nd_booking_display_none nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
            </div>
            ...
            <div class="nd_booking_toogle_branch_stars_content nd_booking_padding_0_30 nd_booking_section nd_booking_display_none nd_booking_box_sizing_border_box">
              ...
              <p class="nd_booking_width_100_percentage nd_booking_float_left nd_booking_margin_0">
                  ...
                  <img alt="" class="nd_booking_margin_right_5 nd_booking_float_left" width="12" src="'.esc_url(plugins_url('icon-star-full-grey.svg', __FILE__ )).'">
                  <img alt="" class="nd_booking_margin_right_5 nd_booking_float_left" width="12" src="'.esc_url(plugins_url('icon-star-full-grey.svg', __FILE__ )).'">
                  <img alt="" class="nd_booking_margin_right_5 nd_booking_float_left" width="12" src="'.esc_url(plugins_url('icon-star-full-grey.svg', __FILE__ )).'">
                  <img alt="" class="nd_booking_margin_right_5 nd_booking_float_left" width="12" src="'.esc_url(plugins_url('icon-star-full-grey.svg', __FILE__ )).'">
                  <img alt="" class="nd_booking_margin_right_5 nd_booking_float_left" width="12" src="'.esc_url(plugins_url('icon-star-full-grey.svg', __FILE__ )).'">
