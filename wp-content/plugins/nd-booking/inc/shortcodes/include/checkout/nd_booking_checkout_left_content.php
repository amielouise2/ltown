...
$nd_booking_new_date_from_format_M = date_i18n('M',strtotime($nd_booking_booking_form_date_from));
$nd_booking_new_date_from_format_l = date_format($nd_booking_new_date_from, 'l');
$nd_booking_new_date_from_format_l = date_i18n('l',strtotime($nd_booking_booking_form_date_from));
...
$nd_booking_new_date_to_format_M = date_i18n('M',strtotime($nd_booking_booking_form_date_to));
$nd_booking_new_date_to_format_l = date_format($nd_booking_new_date_to, 'l');
$nd_booking_new_date_to_format_l = date_i18n('l',strtotime($nd_booking_booking_form_date_to));
...
<div class="nd_booking_section nd_booking_box_sizing_border_box">
  ...
  <div id="nd_booking_checkout_bg_total" class="nd_booking_section nd_booking_bg_greydark_2 nd_booking_padding_30 nd_booking_box_sizing_border_box nd_booking_text_align_center">
      ...
      if ( $nd_booking_booking_original_price != $nd_booking_booking_form_final_price ) {
        $nd_booking_shortcode_left_content .= '<span class="nd_booking_bg_red nd_booking_color_white nd_booking_font_size_10 nd_booking_padding_5 nd_booking_text_transform_uppercase">'.__('The coupon discount has already been applied','nd-booking').'</span>';
      }
