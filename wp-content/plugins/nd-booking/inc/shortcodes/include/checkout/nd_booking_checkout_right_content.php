...
$nd_booking_shortcode_right_content .= '
    ...
    <h1 class="nd_booking_margin_top_50_responsive">'.__('Your Information','nd-booking').' :</h1>
    ...
    if ( get_option('nd_booking_city_tax') != '' OR get_option('nd_booking_vat') != '' ) {
        ...
        <div class="nd_booking_width_100_percentage nd_booking_float_left nd_booking_box_sizing_border_ààbox ">
            ...
            if ( get_option('nd_booking_city_tax') != '' ) {
                $nd_booking_provincial_tax = get_option('nd_booking_city_tax');
                $nd_booking_shortcode_right_content .= '<p>'.__('Included','nd-booking').'</span> '.$nd_booking_provincial_tax.' % '.__('Provincial Tax','nd-booking').' </p>';    
            }
