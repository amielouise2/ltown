...
function acl_admin_custom_login_css() {	
	if(strpos($_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'], 'admin_custom_login') == true) {
		...
		wp_enqueue_style('wl-acl-bootstrap-css', WEBLIZAR_NALF_PLUGIN_URL.'css/bootstrap.min.css');
		...
		wp_enqueue_style('wl-acl-font-awesome_min', WEBLIZAR_NALF_PLUGIN_URL.'font-awesome-latest/css/fontawesome-all.min.css');
...
function acl_admin_custom_login_js() {
	if(strpos($_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'], 'admin_custom_login') == true) {
		...
		wp_enqueue_script('wl-acl-bootstrap-min-js',WEBLIZAR_NALF_PLUGIN_URL.'js/bootstrap.min.js');
